...
roadmapRouter.post(
  ...
  asyncHandler(async (request, response) => {
    ...
    if (!assessment) throw new HttpError(404, "ASSESSMENT_NOT_FOUND", "The assessment was not found.");
        ...
        data: {
          ...
          milestones: {
            create: generated.milestones.map((milestone) => ({
              ...
              resources: milestone.resources as Prisma.InputJsonValue,
            })),
          },
        },
      });
...
roadmapRouter.get(
  ...
  asyncHandler(async (request, response) => {
    ...
    if (!roadmap) throw new HttpError(404, "ROADMAP_NOT_FOUND", "The saved roadmap was not found.");
...
roadmapRouter.patch(
  ...
  asyncHandler(async (request, response) => {
    ...
    if (!milestone) throw new HttpError(404, "MILESTONE_NOT_FOUND", "The milestone was not found.");
...
roadmapRouter.delete(
  ...
  asyncHandler(async (request, response) => {
    ...
    if (!deleted.count) throw new HttpError(404, "ROADMAP_NOT_FOUND", "The saved roadmap was not found.");
